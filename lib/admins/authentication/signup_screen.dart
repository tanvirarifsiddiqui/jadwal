...
class AdminSignUpScreen extends StatefulWidget {
  ...
  const AdminSignUpScreen({required this.mosque}) : super();

  @override
  State<AdminSignUpScreen> createState() => _AdminSignUpScreenState(mosque: mosque);
}

class _AdminSignUpScreenState extends State<AdminSignUpScreen> {
  late Mosque _mosque;

  _AdminSignUpScreenState({required Mosque mosque}) {
    _mosque = mosque;
  }
  ...
  validateAdminPhone() async {
    try {
      var res = await http.post(Uri.parse(API.validateAdminPhone), body: {
      ...
      if (res.statusCode == 200) {
        ...
        if (resBodyOfValidateEmail['phoneFound']) {
          Fluttertoast.showToast(
              msg:
                  "Phone number is already in someone else use. Try another phone number.");
        } else {
...
// Add text fields to the request
      ...
      request.fields['admin_email'] = _mosque.mosque_email;
                                        ...
                                        onTap: () {
                                          if (formKey.currentState!
                                            ...
                                            if (passwordController.text
                                              ...
                                              Fluttertoast.showToast(
                                                  msg:
                                                      "Wrong password confirmation occurred.");
                                            }
                                          }
                                        },
                                        borderRadius: BorderRadius.circular(30),
